"""Tests for ghcn_calibration signal."""
import math
import sys
...
from core.signals.ghcn_calibration_signal import GHCNCalibrationSignal
...
class TestGHCNCalibrationSignal:
    """Test suite for GHCNCalibrationSignal."""

    def test_signal_can_be_imported(self):
        """Test 1: Signal can be imported from its module."""
        sig = GHCNCalibrationSignal()
        assert sig is not None
        assert sig.name == "ghcn_calibration"
    ...
    def test_constructor_takes_reasonable_arguments(self):
        ...
        sig = GHCNCalibrationSignal(db_path=None)
        assert sig is not None
        sig2 = GHCNCalibrationSignal()
