...
from core.signals.rdae_mos_signal import RDAEMOSSignal
...
class TestRDAEMOSSignal:
    ...
    def test_constructor_takes_reasonable_arguments(self):
        ...
        sig = RDAEMOSSignal(db_path=None)
        assert sig is not None
        sig2 = RDAEMOSSignal()
