...
class TestGaussianV2Signal:
    """Test suite for GaussianV2Signal."""

    def test_signal_can_be_imported(self):
        """Test 1: Signal can be imported from its module."""
        sig = GaussianV2Signal()
        assert sig is not None
        assert sig.name == "gaussian_v2"
    ...
    def test_constructor_takes_reasonable_arguments(self):
        ...
        sig = GaussianV2Signal(db_path=None)
        assert sig is not None
        sig2 = GaussianV2Signal()
