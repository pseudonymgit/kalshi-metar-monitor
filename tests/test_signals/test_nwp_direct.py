...
class TestNwpDirectSignal:
    ...
    def test_constructor_takes_reasonable_arguments(self):
        ...
        sig = NwpDirectSignal(db_path=None)
        assert sig is not None
        sig2 = NwpDirectSignal()
