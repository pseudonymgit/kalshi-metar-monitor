"""Tests for forecast_disagreement signal."""
import math
import sys
...
class TestForecastDisagreementSignal:
    ...
    def test_constructor_takes_reasonable_arguments(self):
        ...
        sig = ForecastDisagreementSignal(db_path=None)
        assert sig is not None
        sig2 = ForecastDisagreementSignal()
