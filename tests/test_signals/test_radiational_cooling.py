"""Tests for radiational_cooling signal."""
import math
import sys
...
class TestRadiationalCoolingSignal:
    """Test suite for RadiationalCoolingSignal."""

    def test_signal_can_be_imported(self):
        """Test 1: Signal can be imported from its module."""
        sig = RadiationalCoolingSignal()
        assert sig is not None
        assert sig.name == "radiational_cooling"
    ...
    def test_constructor_takes_reasonable_arguments(self):
        ...
        sig = RadiationalCoolingSignal(db_path=None)
        assert sig is not None
        sig2 = RadiationalCoolingSignal()
