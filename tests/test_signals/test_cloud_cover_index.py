"""Tests for cloud_cover_index signal."""
import math
import sys
...
class TestCloudCoverIndexSignal:
    """Test suite for CloudCoverIndexSignal."""
    ...
    def test_constructor_takes_reasonable_arguments(self):
        ...
        sig = CloudCoverIndexSignal(db_path=None)
        assert sig is not None
        sig2 = CloudCoverIndexSignal()
