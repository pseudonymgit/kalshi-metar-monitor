"""Tests for calendar_climatology signal."""
import math
import sys
...
class TestCalendarClimatologySignal:
    ...
    def test_constructor_takes_reasonable_arguments(self):
        ...
        sig = CalendarClimatologySignal(db_path=None)
        assert sig is not None
        sig2 = CalendarClimatologySignal()
