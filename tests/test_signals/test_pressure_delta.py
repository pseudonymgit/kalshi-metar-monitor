"""Tests for pressure_delta signal."""
import math
import sys
...
class TestPressureDeltaSignal:
    ...
    def test_constructor_takes_reasonable_arguments(self):
        ...
        sig = PressureDeltaSignal(db_path=None)
        assert sig is not None
        sig2 = PressureDeltaSignal()
