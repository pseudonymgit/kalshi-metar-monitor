...
class TestSimpleTrendSignal:
    ...
    def test_constructor_takes_reasonable_arguments(self):
        ...
        sig = SimpleTrendSignal(db_path=None)
        assert sig is not None
        sig2 = SimpleTrendSignal()
