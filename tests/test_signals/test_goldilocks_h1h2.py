...
class TestGoldilocksSignal:
    """Test suite for GoldilocksSignal."""

    def test_signal_can_be_imported(self):
        """Test 1: Signal can be imported from its module."""
        sig = GoldilocksSignal()
        assert sig is not None
        assert sig.name == "goldilocks"
    ...
    def test_constructor_takes_reasonable_arguments(self):
        ...
        sig = GoldilocksSignal(db_path=None)
        assert sig is not None
        sig2 = GoldilocksSignal()
