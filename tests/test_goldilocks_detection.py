...
class GoldilocksConfidenceScoringTests(unittest.TestCase):
    ...
    def test_confidence_inversion_transient_beats_structural(self):
        ...
        transient_conf, _ = metar_monitor._compute_goldilocks_confidence(transient_tracker)
        structural_conf, _ = metar_monitor._compute_goldilocks_confidence(structural_tracker)
    ...
    def test_margin_threshold_boundary(self):
        ...
        conf_below, factors_below = metar_monitor._compute_goldilocks_confidence(tracker_below)
        conf_at, factors_at = metar_monitor._compute_goldilocks_confidence(tracker_at)
    ...
    def test_down_reversion_discount_applied(self):
        ...
        conf_up, _ = metar_monitor._compute_goldilocks_confidence(tracker, is_down=False)
        conf_down, _ = metar_monitor._compute_goldilocks_confidence(tracker, is_down=True)
    ...
    def test_backward_compat_fields_preserved(self):
        ...
        _, factors = metar_monitor._compute_goldilocks_confidence(tracker)
