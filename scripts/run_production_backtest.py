...
risk_manager.config.consecutive_loss_limit = 5   # REAL 5-loss rule ENABLED

DB_PATH = "data/metar_backfill.db"
CALIB_PATH = "scripts/calibration_map.npy"

print("=== PRODUCTION BACKTEST (5-loss + calibration) ===")
...
print("Directional accuracy (5-loss + calibration):", round(acc, 2), "%")
