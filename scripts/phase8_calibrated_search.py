#!/usr/bin/env python3
"""
PHASE 8 — TASK 8.2: Calibration-Insider-Search
...
def main():
    parser = argparse.ArgumentParser(description='Phase 8 Calibrated Search Inside Search')
    parser.add_argument('--db-path', type=str, default='data/metar_backfill.db',
                        help='Path to METAR database')
    parser.add_argument('--output', type=str, default='data/phase8_calibrated_search.json',
                        help='Output file')
...
def print_summary(results: Dict):
    ...
    print("\n" + "="*100)
    print("PHASE 8 — TOP 5 BY CALIBRATED ACCURACY (With Calibration Inside Search Loop)")
    print("="*100)
    ...
    print(f"  Signals tested: {results['phase8_calibrated_search']['signals_tested']}")
    print(f"  Total combinations generated: {results['phase8_calibrated_search']['total_combinations']}")
    print(f"  Combinations evaluated: {results['phase8_calibrated_search']['combinations_evaluated']}")
    print(f"  Station count: {len(results['phase8_calibrated_search']['stations'])}")
    print(f"  Agreement levels tested: {results['phase8_calibrated_search']['agreement_levels']}")
