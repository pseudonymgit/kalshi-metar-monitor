...
risk_manager.config.consecutive_loss_limit = 50   # relaxed for diagnostic run

DB_PATH = "data/metar_backfill.db"

print("=== REAL 7-SIGNAL RISK-GATED BACKTEST (DIAGNOSTIC) ===")
print("Stations:", STATIONS)
print("Note: consecutive_loss_limit temporarily raised to 50 for this run")
