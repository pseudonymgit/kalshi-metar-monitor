...
## Integrity Reviews
- `docs/REVIEW_RUNTIME_INTEGRITY_2026-03-04.md` — Runtime integrity review of execution path and safety constraints.
- `docs/REVIEW_CAUSAL_CHAIN_INTEGRITY_2026-03-04.md` — Causal-chain integrity review of event-to-alert determinism.
...
- `docs/INGESTION_VISIBILITY_SPEC.md` — Ingestion visibility behavior and emitted evidence surface.
- `docs/HYDRATION_VISIBILITY_SPEC.md` — Hydration-stage visibility behavior and diagnostics semantics.
- `docs/SCHEDULER_VISIBILITY_SPEC.md` — Scheduler runtime visibility behavior and lifecycle signals.
- `docs/REPLAY_PARITY_VISIBILITY_SPEC.md` — Replay parity visibility requirements for run equivalence.
...
- `docs/ARCHIVE/` — Legacy archive path retained for older historical snapshots.
